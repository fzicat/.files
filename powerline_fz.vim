...
let s:p.tabline.left = [ [ 'yellow', 'gray1' ] ]
let s:p.tabline.tabsel = [ [ 'gray1', 'yellow' ] ]
let s:p.tabline.middle = [ [ 'gray8', 'gray1' ] ]
let s:p.tabline.right = [ [ 'gray9', 'gray4' ] ]
let s:p.normal.error = [ [ 'gray9', 'brightestred' ] ]
let s:p.normal.warning = [ [ 'gray1', 'yellow' ] ]

let g:lightline#colorscheme#powerline_fz#palette = lightline#colorscheme#fill(s:p)
